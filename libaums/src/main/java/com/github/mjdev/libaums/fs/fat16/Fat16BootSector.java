...
/* package */class Fat16BootSector {
    ...
    private static final int ROOT_ENTIRES_COUNT_OFF = 17;
    private static final int SMALL_SECTOR_COUNT_OFF = 19;
    private static final int SECTORS_PER_FAT_OFF = 22;
    private static final int SECTORS_PER_TRACK_OFF = 24;
    private static final int HIDDEN_SECTOR_COUNT_OFF = 28;
    private static final int TOTAL_SECTORS_OFF = 32;
    private static final int VOLUME_LABEL_OFF = 43;
    private static final int SYSTEM_ID_OFF = 54;
    ...
    private long rootDirStartSector;
    private boolean fatMirrored;
    private byte validFat;
    private String volumeLabel;
    private int maxRootEntryCount;
    private long dataStartSector;
     ...
     */
    /* package */
    static Fat16BootSector read(ByteBuffer buffer) {
        ...
        result.maxRootEntryCount = buffer.getShort(ROOT_ENTIRES_COUNT_OFF);
        result.totalNumberOfSectors = buffer.getInt(TOTAL_SECTORS_OFF) & 0xffffffffl;
        result.sectorsPerFat = buffer.getInt(SECTORS_PER_FAT_OFF) & 0x0000ffffl;
        result.rootDirStartSector = result.reservedSectors + (result.fatCount * result.sectorsPerFat);
        result.dataStartSector = result.rootDirStartSector + ((result.maxRootEntryCount * DIRECTORY_ENTRY_BYTE_SIZE) / result.bytesPerSector);
        result.fatMirrored = true;
        result.validFat = 1;
     ...
     */
    /* package */long getRootDirStartSector() {
        return rootDirStartSector;
    }
