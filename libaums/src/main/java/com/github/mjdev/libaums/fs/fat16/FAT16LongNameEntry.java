 ...
 * 
 */
/* package */class FAT16LongNameEntry {
	...
	/**
	 * Creates a new {@link #FAT16LongNameEntry()} with the given information.
	 * 
	 * @param actualEntry
	 ...
	 */
	private FAT16LongNameEntry(FatDirectoryEntry actualEntry, String lfnName) {
		this.actualEntry = actualEntry;
		this.lfnName = lfnName;
	}

	/**
	 * Creates a completely new {@link #FAT16LongNameEntry()}.
	 * 
	 * @param name
	 *            The long file name.
	 * @param shortName
	 ...
	 */
	/* package */static FAT16LongNameEntry createNew(String name, ShortName shortName) {
		FAT16LongNameEntry result = new FAT16LongNameEntry();
	...
	/**
	 * Reads a {@link #FAT16LongNameEntry()} with the given information.
	 * 
	 * @param actualEntry
	 *            The actual entry.
	 * @param lfnParts
	 ...
	 * @return The newly created entry.
	 */
	/* package */static FAT16LongNameEntry read(FatDirectoryEntry actualEntry,
		...
		if (lfnParts.size() > 0) {
			...
			return new FAT16LongNameEntry(actualEntry, builder.toString());
		}

		return new FAT16LongNameEntry(actualEntry, null);
	}
	 ...
	 *            The destination.
	 */
	/* package */static void copyDateTime(FAT16LongNameEntry from, FAT16LongNameEntry to) {
	...
	public String toString() {
		return "[FAT16LongNameEntry getName()=" + getName() + "]";
	}
}
