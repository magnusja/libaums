...
public class FatDirectoryEntry {
     ...
     * @see #setDirectory()
     */
    public static FatDirectoryEntry createNew(FatType fatType) {
    ...
    public long getStartCluster() {
        if (this.fatType == FatType.FAT32) {
            ...
            return getUnsignedInt16(LSB_CLUSTER_OFF);
        }
    ...
    public void setStartCluster(long newStartCluster) {
        if (newStartCluster > Integer.MAX_VALUE) throw new AssertionError();
        ...
        if (this.fatType == FatType.FAT32) {
            ...
            setUnsignedInt16(MSB_CLUSTER_OFF, (int) newStartCluster);
        }
     ...
     * @param checksum The checksum of the short name (
