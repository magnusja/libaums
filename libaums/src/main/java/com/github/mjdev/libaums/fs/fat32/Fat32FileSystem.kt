...
private constructor(blockDevice: BlockDeviceDriver, first512Bytes: ByteBuffer) : FileSystem {
    ...
    private val rootDirectory: FatDirectory

    override val volumeLabel: String
        get() {
            var volumeLabel = rootDirectory.volumeLabel
            if (volumeLabel == null) {
                volumeLabel = bootSector.volumeLabel
            }
            return volumeLabel
        }
    ...
    override fun getRootDirectory(): UsbFile {
