...
/* package */class FatDirectoryEntry {
    ...
    private static final int FILE_NAME_OFF = 0x00;
    private static final int FILE_EXT_OFF = 0x08;
    ...
    private static final int FIRST_CLUSTER_OFF = 0x1a;
    ...
    public void setStartCluster(long newStartCluster) {
        setUnsignedInt16(FIRST_CLUSTER_OFF, (int) newStartCluster);
    }
}
