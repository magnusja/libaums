...
public class ClusterChain {
     ...
     * @param fatIntf      The file allocation table.
     * @param bootSector   The boot sector of the FAT32 fs.
     * @throws IOException
     */
    public ClusterChain(long startCluster, BlockDeviceDriver blockDevice, FatIntf fatIntf,
                        BootSector bootSector) throws IOException {
        this.fat = fatIntf;
     ...
     * @param dest   The destination buffer the contents of the chain shall be
     *               copied to.
     ...
     * @param source The buffer which holds the contents which shall be transferred
