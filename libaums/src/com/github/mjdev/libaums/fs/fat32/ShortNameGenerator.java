...
/**
 * This class is responsible for generating valid 8.3 short names for any given long file name.
 * @author mjahnen
...
/* package */ class ShortNameGenerator {
	 ...
	 * @return True if the String contains any invalid chars which are not allowed on 8.3 short names.
	 */
	 ...
	 * @param str The string where invalid chars shall be replaced.
	...
	/**
	 * Generates an 8.3 short name for a given long file name. It creates a suffix at the end of the short name
	 * if there is already a existing entry in the directory with an equal short name.
	 * @param lfnName Long file name.
	 * @param existingShortNames The short names already existing in the directory.
	...
	/* package */ static ShortName generateShortName(String lfnName, Collection<ShortName> existingShortNames) {
		...
		// also create the suffix if the length is bigger than 8 or the short name already exists
