...
/**
 * This class holds the information of an 32 byte FAT32 directory entry. It holds
 * information such as if an entry is a directory, read only or hidden.
 * <p>
 * There are three cases a {@link #FatDirectoryEntry()} is used:
 * <ul>
 * <li> To store information about a directory or a file.
 * <li> To store a part of a long filename. Every entry can store up to 13 bytes of a long file name.
 * <li> To store a volume label which can occur in the root directory of a FAT32 file system.
 * </ul>
 * <p>
...
/* package */ class FatDirectoryEntry {
    ...
    /**
     * Creates a completely new {@link #FatDirectoryEntry()}. Do not forget to set the start cluster!
     * The time fields ({@link #setCreatedDateTime(long)}, {@link #setLastAccessedDateTime(long)},
    ...
    /**
     * Reads a directory {@link #FatDirectoryEntry()} from the given buffer and updates the position of
     * the buffer if successful! Returns <code>null</code> if there are no further
     * entries. 
     * @param data The buffer where the entries are located.
    ...
    /**
     * Returns true if the current {@link #FatDirectoryEntry()} is an long filename entry.
	...
	/**
	 * Returns true if the current {@link #FatDirectoryEntry()} denotes a directory.
	...
	/**
	 * Sets a mark that indicates that this {@link #FatDirectoryEntry()} shall denote a directory.
	 */
	...
	/**
	 * Returns true if the current {@link #FatDirectoryEntry()} denotes a volume label.
	...
	/**
	 * Returns true if the current {@link #FatDirectoryEntry()} is a system file or directory.
	 * Normally a user shall not see this item!
	...
	/**
	 * Returns true if the current {@link #FatDirectoryEntry()} is an archive. This is used by
	 * backup tools.
	...
	/**
	 * Returns true if the current {@link #FatDirectoryEntry()} is a read only file or directory.
	 * Normally a user shall not be able to write or to alter this item!
	...
	/**
	 * Returns true if the {@link #FatDirectoryEntry()} was deleted and shall not show up in
	 * the file tree.
	 ...
	 * @param dateTime Time in milliseconds since January 1 00:00:00, 1970 UTC
	 */
	...
	/**
	 * Returns the time this {@link #FatDirectoryEntry()} was accessed the last time.
	 * @return Time in milliseconds since January 1 00:00:00, 1970 UTC
	 */
	...
	/**
	 * Sets the time this {@link #FatDirectoryEntry()} was accessed the last time.
	 * @param dateTime Time in milliseconds since January 1 00:00:00, 1970 UTC
	 */
	...
	/**
	 * Returns the time this {@link #FatDirectoryEntry()} was modified the last time.
	 * @return Time in milliseconds since January 1 00:00:00, 1970 UTC
	 */
	...
	/**
	 * Sets the time this {@link #FatDirectoryEntry()} was modified the last time.
	 * @param dateTime Time in milliseconds since January 1 00:00:00, 1970 UTC.
	 */
	...
	/**
	 * Sets the short name for this {@link #FatDirectoryEntry()} and writes it to the
	 * data array.
	...
	/**
	 * Creates a new {@link #FatDirectoryEntry()} to hold the volume directory in the root directory of
	 * a FAT32 file system.
	...
	/**
	 * Returns the volume label which can occur in the root directory of a FAT32 file system.
	...
	/**
	 * Returns the start cluster for this {@link #FatDirectoryEntry()}. The start cluster denotes where a file or a directory
	 * start in the fs.
	...
	/**
	 * Sets the start cluster for this {@link #FatDirectoryEntry()}. The start cluster denotes where a file or a directory
	 * start in the fs.
	 * @param newStartCluster The start cluster
	 * @see #getStartCluster()
	 */
	...
	/**
	 * Returns the size of a file in bytes. For directories this value should always be zero.
	...
	/**
	 * Sets the size of a file in bytes. For directories this value should always be zero.
	 * @param newSize The file size in bytes.
	 * @see #getFileSize()
	 */
	 ...
	 * @param index The index of this entry, starting at one.
	 * @param isLast True if this is the last entry.
	...
	/**
	 * This method extracts the long filename part of the {@link #FatDirectoryEntry()}. It appends the long filename part to the
	 * StringBuilder given.
	 * @param builder The builder where the long filename part shall be appended.
	 * @see #createLfnPart(String, int, byte, int, boolean)
	 * @see #isLfnEntry()
	 */
	 ...
	 * @param date The data of the entry.
	...
	/**
	 * This method encodes the date given to a timestamp suitable for an {@link #FatDirectoryEntry()}.
	 * @param timeInMillis Time in milliseconds since January 1 00:00:00, 1970 UTC.
	...
	/**
	 * This method encodes the time given to a timestamp suitable for an {@link #FatDirectoryEntry()}.
	 * @param timeInMillis Time in milliseconds since January 1 00:00:00, 1970 UTC.
