...
public class ClusterChain {
	 ...
	 * @param startCluster The start cluster which shall be followed in the FAT.
	 * @param blockDevice The block device where the fat fs is located.
	 * @param fat The file allocation table.
	 * @param bootSector The boot sector of the FAT32 fs.
	 * @throws IOException
	 */
	...
	/* package */ void read(long offset, ByteBuffer dest) throws IOException {
        ...
        // if the offset is not a multiple of the cluster size we have to start reading
	...
	/**
	 * Returns the offset of a cluster from the beginning of the FAT32 file system in bytes.
	 * @param cluster The desired cluster.
	 * @param clusterOffset The desired offset in bytes in the cluster.
	 * @return Offset in bytes from the beginning of the disk (FAT32 file system).
	 */
	...
	/**
	 * Sets the new length in bytes of this chain. This method allocates or frees new
	 * space on the disk depending on the new length.
