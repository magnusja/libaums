...
/**
 * This class represents a long file name entry. The long file name can be accessed via {@link #getName()}.
 * This class delegates most actions to the {@link #actualEntry}. It is responsible for parsing and serializing
 * long file names and the actual entry with the corresponding short name.
 * <p>
 * To understand the structure of long file name entries it is advantageous to look at the official 
 * FAT32 specification.
 * @author mjahnen
 *
 */
/* package */ class FatLfnDirectoryEntry {
	...
	/**
	 * The actual entry which holds information like the start cluster
	 * and the file size.
	 */
	private FatDirectoryEntry actualEntry;
	/**
	 * The long file name or null if the actual entry does not have
	 * a long file name.
	 */
	 ...
	 * @param actualEntry The actual entry in the FAT directory.
	 * @param lfnName The long file name, can be null.
	 */
	 ...
	 * @param name The long file name.
	 * @param shortName The generated short name.
	...
	/**
	 * Serializes the long file name and the actual entry in the order needed into the buffer.
	 * Updates the position of the buffer. 
	 * @param buffer The buffer were the serialized data shall be stored.
	 */
	...
	/**
	 * This method returns the entry count needed to store the long file name and the actual entry.
	...
	/**
	 * Returns the name for this entry. If the long file name is not specified it returns
	 * the short name.
	 ...
	 * @param newName The new long name.
	 ...
	 * @param newStartCluster The new start cluster.
	 * @see #getStartCluster()
	 */
	...
	/**
	 * Returns the actual entry which holds the information like start cluster or file size.
